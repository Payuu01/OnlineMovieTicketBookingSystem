	...
	<div class="wrap">
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2" style="width: 100%">	
						<h3><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								<div class="grid images_3_of_2" style="width:18%; margin-left:100px;">
								...
								?>
									...
									<tr>
										<td colspan="2"><?php if($avl[0]==$screen['seats']){?><button type="button" class="btn btn-danger" style="width:100%">House Full</button><?php } else { ?>
											<a href="book.php" class="btn btn-info" style="width:100%">Book Now</a>
										<?php } ?>
										</form></td>
									</tr>
						<table>
