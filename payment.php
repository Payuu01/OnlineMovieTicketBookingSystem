									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="payment-info">
											...
											<form>
													...
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																...
																<li>
																	<input type="number" class="text_box" type="text" value="2025" min="1" />	
																</li>
												...
												<div class="transaction">
													<div class="tab-form-left user-form">
													<h5>Transaction Amount</h5> 	<input type="" class="text_box" type="text" value = "INR <?php echo  $_SESSION['amount'];?>" min="1" />
					                                </div>
					                           </div>
                                                <br><br>
												<br><br>
										...
										<div class="payment-info">
											...
											<form>
												<div class="tab-for">				
													...
													<h5>CARD NUMBER</h5>													
														<input class="pay-logo" id="Card" type="text" value="0000-0000-0000-0000" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '0000-0000-0000-0000';}" required="">
												</div>	
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
											   ...
											   <br><br>
											   <br><br>
												<input  onclick="takeData()" type="submit" value="SUBMIT">
											</form>
											<div class="single-bottom">
													<ul>
														<li>
...
<script>
	 	function takeData() {
            if (($("#Username").val().length == 0) || ($("#Card").val().length == 0)) {
                alert("Please Enter your Details");
            } else {
                alert("Payment Successfulled");
			}
		}
</script>
</body>
